...
import {SearchIcon, ShoppingCart} from "lucide-react-native";
...
export default function Index() {
    ...
    const fetchProducts = async (category = '') => {
        ...
        const products = [
            ...
            },
            {
                ...
                discount: '21% OFF',
                weight: '500g',
                image: 'https://images.unsplash.com/photo-1599819177795-d4ab271c2b0f?w=200&h=200&fit=crop',
            },
            {
                id: 5,
                name: 'Strawberries',
    ...
    console.log('@/app/index: Display Products: ', displayProducts)
    console.log('@/app/index: Item Count: ', itemCount);
    return (
